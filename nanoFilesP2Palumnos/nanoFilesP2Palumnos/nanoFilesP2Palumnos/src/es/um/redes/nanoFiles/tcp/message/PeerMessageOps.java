...
public class PeerMessageOps {
	...
	public static final byte OPCODE_AMBIGUOUS_NAME = 3;
	public static final byte OPCODE_FILE_NOT_FOUND = 4;
	public static final byte OPCODE_GET_CHUNK = 5;
	public static final byte OPCODE_RECEIVE_CHUNK = 6;
	public static final byte OPCODE_UPLOAD_FILE = 7;
	public static final byte OPCODE_FILE_FOUND = 8;
	public static final byte OPCODE_SEND_CHUNK = 9;
	 ...
	 */
	private static final Byte[] _valid_opcodes = { OPCODE_INVALID_CODE, OPCODE_DOWNLOAD_FILE, OPCODE_FILE_METADATA, OPCODE_AMBIGUOUS_NAME, OPCODE_FILE_NOT_FOUND, OPCODE_GET_CHUNK, OPCODE_RECEIVE_CHUNK, OPCODE_UPLOAD_FILE, OPCODE_FILE_FOUND, OPCODE_SEND_CHUNK};
	private static final String[] _valid_operations_str = { "INVALID_OPCODE", "DOWNLOAD_FILE", "FILE_METADATA", "AMBIGUOUS_NAME", "FILE_NOT_FOUND", "OPCODE_GET_CHUNK", "OPCODE_RECEIVE_CHUNK"};
